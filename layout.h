...
typedef void (* layout_enume_cb_t )( char *, double, double,
				     char *, double, double );
typedef void (* layout_update_cb_t)( int );

void layout_open( void **, void ** );
void layout_close( void *, void *, void * );
void layout_add_edge( void *, void *, char *, char * );
void layout_run( void *, void **, int, double, double, layout_update_cb_t  );
